...
class EventLogRepositoryImplTest {
    ...
    @Mock
    private JpaEventLogRepository jpaRepository;

    @Mock
    private JpaFutureCallRepository jpaFutureCallRepository;

    private EventLogRepositoryImpl repository;

    @BeforeEach
    void setUp() {
        repository = new EventLogRepositoryImpl(jpaRepository, jpaFutureCallRepository);
    }
